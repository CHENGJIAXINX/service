...
public abstract class BaseWxUserWallet<M extends BaseWxUserWallet<M>> extends TioModel<M> implements IBean {
	 ...
	 * 运行商状态：1：认证；2：未认证；
	 */
	public void setOperatorstatus(java.lang.Byte operatorstatus) {
	 ...
	 * 运行商状态：1：认证；2：未认证；
	 */
	public java.lang.Byte getOperatorstatus() {
		return getByte("operatorstatus");
	}

	/**
	 * 实名认证：1：认证；2：未认证
	 */
	public void setRealnamestatus(java.lang.Byte realnamestatus) {
	 ...
	 * 实名认证：1：认证；2：未认证
	 */
	public java.lang.Byte getRealnamestatus() {
		return getByte("realnamestatus");
	}
	 ...
	 * 异常同步：1：已处理：2：未处理
	 */
	public void setExcepsyn(java.lang.Byte excepsyn) {
	 ...
	 * 异常同步：1：已处理：2：未处理
	 */
	public java.lang.Byte getExcepsyn() {
		return getByte("excepsyn");
	}
