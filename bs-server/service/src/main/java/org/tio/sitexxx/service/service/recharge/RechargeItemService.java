 ...
 */
package org.tio.sitexxx.service.service.recharge;
...
import org.tio.sitexxx.service.service.atom.RechargeAtom;
	...
	public void attackRecharge(RechargeItem rechargeItem) throws Exception {
		AbsAtom attackAtom = new AbsAtom() {
			...
			public boolean run() throws SQLException {
				...
				Double addCoin = NumberUtil.mul((double) rechargeItem.getAmount(), (float) ConfService.getInt(Const.ConfMapping.CNY_TO_COIN_TIME_IOS, 70));
