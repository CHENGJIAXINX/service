	...
	public static WxGroupChatNtf from(WxGroupMsg msg, SysMsgVo sysMsgVo) {
		...
		switch (msg.getContenttype()) {
			...
			case Const.ContentType.LOCATION:
				YxLocationMsgVo locationMsgVo = Json.toBean(msg.getText(), YxLocationMsgVo.class);
				reslut.setLocation(locationMsgVo);
				break;
			case Const.ContentType.FACE_EMOTION:
				YxFaceEmotionMsgVo faceEmotionMsgVo = Json.toBean(msg.getText(), YxFaceEmotionMsgVo.class);
				reslut.setFaceEmotion(faceEmotionMsgVo);
				break;
			case Const.ContentType.TRANS_SEND:
				TransSendVo transSendVo = Json.toBean(msg.getText(), TransSendVo.class);
				reslut.setTransSendVo(transSendVo);
				break;
